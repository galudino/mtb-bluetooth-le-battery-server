...
##
## # Build combined MCUBoot and mtb-example-btstack-freertos-battery-server debug hex file
## % ./scripts/build-combined-mcuboot-app-and-mtb-example-btstack-freertos-battery-server-debug.sh nocopy
##
## # Use the "copy" argument to copy the final combined hex to current directory
## % ./scripts/build-combined-mcuboot-app-and-mtb-example-btstack-freertos-battery-server-debug.sh copy
##
...
function main() {
    ...
    ./scripts/combine-mcuboot-app-and-mtb-example-btstack-freertos-battery-server-debug.sh
}
